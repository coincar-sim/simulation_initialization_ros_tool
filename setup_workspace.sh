...
git clone https://git.rwth-aachen.de/spp1835/simulation_utils_ros_tool
...
git clone https://git.rwth-aachen.de/spp1835/sim_sample_actuator_ros_tool
git clone https://git.rwth-aachen.de/spp1835/sim_sample_communication_ros_tool
git clone https://git.rwth-aachen.de/spp1835/desired_motion_rviz_plugin_ros
git clone https://git.rwth-aachen.de/spp1835/lanelet_rviz_plugin_ros
git clone https://git.rwth-aachen.de/spp1835/motion_state_rviz_plugin_ros
